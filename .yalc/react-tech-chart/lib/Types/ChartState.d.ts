...
/** Hook */
export declare type ChartStateDispatch<Action extends ReducerTask> = React.Dispatch<ReducerAction<Action>>;
export declare type ChartStateHook<Action extends ReducerTask = ReducerTask> = {
