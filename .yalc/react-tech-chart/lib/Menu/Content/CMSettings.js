...
export var CMSettings = function (props) {
    var subCharts = props.subCharts, onNavigate = props.onNavigate, Dispatch = props.Dispatch, onSettingsExpand = props.onSettingsExpand, ChartMenuState = props.ChartMenuState, options = props.options, data = props.data;
    var theme = useTheme();
    ...
    var generalSettings = [
        {
            ...
            iconPath: mdiWater,
            labelInfo: (_jsx(Colorpicker, { color: options.backgroundColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiWater,
            labelInfo: (_jsx(Colorpicker, { color: options.xaxis.fillColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            labelInfo: (_jsx(Colorpicker, { color: options.xaxis.strokeColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            labelInfo: (_jsx(Colorpicker, { color: options.xaxis.fontColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            labelText: "stroke color",
            iconPath: mdiBorderColor,
            labelInfo: (_jsx(Colorpicker, { color: options.yaxis.strokeColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            labelText: "text color",
            iconPath: mdiFormatText,
            labelInfo: (_jsx(Colorpicker, { color: options.yaxis.fontColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiGrid,
            labelInfo: (_jsx(Checkbox, { checked: options.grid.useGridX, size: "small", style: { padding: 0, width: 24, height: 24 }, onChange: function () {
        ...
        },
        {
            ...
            iconPath: mdiGrid,
            labelInfo: (_jsx(Checkbox, { checked: options.grid.useGridY, size: "small", style: { padding: 0, width: 24, height: 24 }, onChange: function () {
        ...
        },
        {
            ...
            labelText: "stroke color",
            iconPath: mdiBorderColor,
            labelInfo: (_jsx(Colorpicker, { color: options.grid.strokeColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            labelInfo: (_jsx(Checkbox, { checked: options.crosshair.useCrosshair, size: "small", style: { padding: 0, width: 24, height: 24 }, onChange: function () {
        ...
        },
        {
            ...
            labelText: "stroke color",
            iconPath: mdiBorderColor,
            labelInfo: (_jsx(Colorpicker, { color: options.crosshair.strokeColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiWater,
            labelInfo: (_jsx(Colorpicker, { color: options.crosshair.xMarkerBackgroundColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiBorderColor,
            labelInfo: (_jsx(Colorpicker, { color: options.crosshair.xMarkerStrokeColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiFormatText,
            labelInfo: (_jsx(Colorpicker, { color: options.crosshair.xMarkerTextColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiWater,
            labelInfo: (_jsx(Colorpicker, { color: options.crosshair.yMarkerBackgroundColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiBorderColor,
            labelInfo: (_jsx(Colorpicker, { color: options.crosshair.yMarkerStrokeColor, onColorSelected: function (color) {
        ...
        },
        {
            ...
            iconPath: mdiFormatText,
            labelInfo: (_jsx(Colorpicker, { color: options.crosshair.yMarkerTextColor, onColorSelected: function (color) {
    ...
    return (_jsxs(React.Fragment, { children: [_jsxs(Stack // menu
            , __assign({ direction: "row", alignItems: "center", justifyContent: "flex-end", sx: { pt: 0.5 } }, { children: [_jsx(Button, __assign({ style: {
                            ...
                            vertical: "top",
                            horizontal: "right",
                        } }, { children: [_jsx(MenuItem, __assign({ onClick: function () { return handleClose("indicators"); } }, { children: "Indicator" }), void 0), _jsx(MenuItem, __assign({ onClick: function () { return handleClose("tools"); } }, { children: "Tool" }), void 0)] }), void 0)] }), void 0), _jsxs(CTreeView, __assign({ expanded: ChartMenuState.expandedSetting }, { children: [_jsx(CTreeItem, __assign({ nodeId: "1", labelText: "General", labelIcon: _jsx(CIcon, { path: mdiFileChartOutline, size: "32px", color: theme.palette.secondary.contrastText, background: theme.palette.secondary.main }, void 0), bgColorSelected: theme.palette.primary.light, typographyVariant: "h6", onClick: function () {
                            var id = "1";
                        ...
                        }) }), void 0), _jsx(SubchartTreeItem, { subcharts: subCharts, data: data, subchartIdx: 0, Dispatch: Dispatch, onSettingsExpand: onSettingsExpand }, void 0), _jsx(DragDropContext, __assign({ onDragEnd: function (res) {
                            var _a;
                                ...
                                params: {
                                    ...
                                    borderBottomRightRadius: theme.spacing(2),
                                        ...
                                        return (_jsx(Draggable, __assign({ draggableId: "sub-".concat(subchartIdx), index: subchartIdx }, { children: function (provided, snapshot) {
                                                return (_jsx(SubchartTreeItem, __assign({ subcharts: subCharts, data: data, subchartIdx: subchartIdx, Dispatch: Dispatch, onSettingsExpand: onSettingsExpand, ref: provided.innerRef }, provided.draggableProps, { additionalLabelInfo: _jsx(IconButton, __assign({ size: "small" }, provided.dragHandleProps, { children: _jsx(Icon, { path: mdiArrowUpDownBold, size: 1, color: theme.palette.mode === "light" ? "#333" : "#fff" }, void 0) }), void 0) }), void 0));
                                            } }), "sub-".concat(subchartIdx)));
                                    }), provided.placeholder] }), void 0)); } }), void 0) }), void 0)] }), void 0)] }, void 0));
};
//# sourceMappingURL=CMSettings.js.map