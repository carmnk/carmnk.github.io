...
export var CMChart = function (props) {
    var Dispatch = props.Dispatch, events = props.events, settings = props.settings;
    var theme = useTheme();
    ...
    function handleInputFileChange(evt) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var files, dataSeries, graphName, id, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        id = uniqid();
                        (_a = events === null || events === void 0 ? void 0 : events.onDataChange) === null || _a === void 0 ? void 0 : _a.call(events, { data: dataSeries, name: graphName, id: id, type: "chart" });
                        Dispatch({
                            task: "addSubchart",
                            params: { dataSeries: dataSeries, graphName: graphName, reset: true, id: id },
                        });
    ...
    function fetchCsvFromURL() {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var resp, file, dataSeries, graphName, id, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        dataSeries = _b.sent();
                        graphName = CsvUrl.substring(CsvUrl.lastIndexOf("/") + 1, CsvUrl.lastIndexOf("."));
                        id = uniqid();
                        (_a = events === null || events === void 0 ? void 0 : events.onDataChange) === null || _a === void 0 ? void 0 : _a.call(events, { data: dataSeries, name: graphName, id: id, type: "chart" });
                        Dispatch({
                            task: "addSubchart",
    ...
    var HandleOnKeyUp = function (e) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var handleSnackbarClose = React.useCallback(function () {
        setIsError(function (current) { return (current.length === 1 ? [] : current.splice(1)); });
    }, []);
    return (_jsxs(React.Fragment, { children: [_jsx("input", { type: "file", style: {
                    visibility: "hidden",
                    position: "absolute",
                    top: 0,
                    height: 0,
