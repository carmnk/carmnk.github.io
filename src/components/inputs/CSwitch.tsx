...
import { Checkbox, CheckboxProps, FormControlLabel, Switch } from '@mui/material'
...
export const CSwitch = (props: CCheckboxProps) => {
  ...
  return (
    <FormControlLabel
      ...
      control={<Switch name={name} value={value} checked={!!value} onChange={onChange} {...restCheckBoxProps} />}
      label={label}
