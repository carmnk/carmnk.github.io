...
const isValidBound = (value?: number, lower?: number) => !value || (Number.isSafeInteger(value) && value > (lower as number));
const idOfLength = (min?: number, max?: number) => {
